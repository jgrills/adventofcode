...
fn main() {
    ...
    if false {
        ...
        for i in 0..bricks {
            let b = brick[i];
            println!("{},{},{} - {},{},{} : {},{},{}", b.brick.start.x, b.brick.start.y, b.brick.start.z, b.brick.end.x, b.brick.end.y, b.brick.end.z, b.step.x, b.step.y, b.step.z);
        }
    }
    ...
    for d in 0..bricks {
        let mut sup_all : bool = true;
        for i in 0..bricks {
            if i == d { continue };

            // Each brick needs to be proven independently stable
            let o = brick[i];
            let mut sup : bool = false;
            for j in 0..bricks {
                if i == j || j == d { continue; }
            ...
            // If this brick isn't supported, fail the support
            if !sup {
                sup_all = false;
                break;
            }
